...
# - Complete the missing data (see Completing_data.py, then put all the code here)
...
#deleting other categories to ease Natural Language Processing:
unused_category += 
...
print(language_df.tail()) #the retained languages and their parameters are well displayed

#4th step: Completing data
